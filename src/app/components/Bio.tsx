export default function Bio() {
    return (
        <div>
            <div className="font-mono text-center md:text-left md:pl-40 md:pt-24 mb-8 md:mb-16">
                <h1 className="text-4xl md:text-6xl font-bold mb-2">DAVID</h1>
                <h1 className="text-4xl md:text-6xl font-bold">RAGIPI</h1>
            </div>
